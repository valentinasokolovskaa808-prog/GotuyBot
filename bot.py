...
from database import init_db, search_recipes
...
# --- Стан для очікування запиту пошуку ---
...
# --- 3. Старт пошуку за кнопкою "Пошук рецепту" ---
